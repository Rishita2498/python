...
def test_left_binary_search_student():
    assert 3==left_binary_search([1,2,4,5,7,5,8],5)
    assert -1==left_binary_search([],1)
    assert 0==left_binary_search([1,2,1,1,1,1,1],1)
    assert -1==left_binary_search([1,2,3,4,5,6],7)
    pass
